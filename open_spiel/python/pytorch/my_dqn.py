...
"""DQN agent implemented in PyTorch, modified to use your neural network"""

'''
Import neural network models
Uncomment the model you want to use, and comment out the others
'''
# from CAS_752.my_models.MLP import MLP as NeuralNetwork
# from CAS_752.my_models.FC_DQN import FC_DQN as NeuralNetwork
# from CAS_752.my_models.CNN import CNN_DQN as NeuralNetwork
# from CAS_752.my_models.GCNN import GCNN_DQN as NeuralNetwork
from CAS_752.my_models.my_nn import myNN as NeuralNetwork
...
class DQN(rl_agent.AbstractAgent):
  ...
  def __init__(self,
    ...
    self._q_network = NeuralNetwork(state_representation_size, num_actions).to(accelerator)

    self._target_q_network = NeuralNetwork(state_representation_size, num_actions).to(accelerator)
